...
SPACE COMPLEXITY:We are only declaring some variables of constant size,space complexity->O(1) but as we are using recursion,due to recursion stack the space complexity->O(n)
